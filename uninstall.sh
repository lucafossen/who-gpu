...
# Generated by --web and the update check; safe to remove. The home-folder
# location is the old default, removed only if it is clearly ours.
rm -rf "${XDG_CACHE_HOME:-$HOME/.cache}/who-gpu"
rm -rf "${WHO_GPU_OUT:-${XDG_DATA_HOME:-$HOME/.local/share}/who-gpu}"
[[ -f "$HOME/who-gpu-web/fleet.html" ]] && rm -rf "$HOME/who-gpu-web"
...
echo "The generated dashboard files were removed."
